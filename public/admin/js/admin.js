...
function initTinyMCExconf(selector, conf_override) {
    ...
    let tiny_default_config = {
        ...
        toolbar2: "responsivefilemanager image | hr charmap nonbreaking | copy cut paste pastetext | visualblocks visualchars template deleteLayout code widgetmanager fontawesome5 insertcontent save",
